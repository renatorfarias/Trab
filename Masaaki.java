...
public class Prova {
    public static void main(String[] args) {
        ...
        if (escolha == 0){
            ...
            while(true){
            	...
            	if(habilidade == 0){ //Comparação: se a habilidade secelcionada for o golpe primário
            		mago.golpePrimario(); //Se aplica o método golpeUltimate()
            	...
            	if(habilidade == 0){
            		dragon.golpePrimario();
            	} else if (habilidade == 1){
                    dragon.golpeSecundario();
            	} else if (habilidade == 2){
            		dragon.golpeEspecial();
            	}	
        ...
        if (escolha == 1){
            ...
            while(true){
            	Object[] golpesDoGuerreiro= {guerreiro.getNomeGolpePrimario(), guerreiro.getNomeGolpeSecundario(), guerreiro.getNomeDoEspecial()};
            	habilidade = JOptionPane.showOptionDialog(null, "Selecione o ataque:", "Usar o golpe", JOptionPane.DEFAULT_OPTION, 3, null, golpesDoGuerreiro, golpesDoGuerreiro[0]);
            	if(habilidade == 0){
            		guerreiro.golpePrimario();
            	} else if (habilidade == 1){
            		guerreiro.golpeSecundario();
            	} else if (habilidade == 2){
           	...
           	if(a == 1){
           		...
           		JOptionPane.showMessageDialog(null, "Vencedor: " + gigante.getNome() + "\n " +"Vida: " + gigante.getVida());
            ...
            while(true){
            	Object[] golpesDoMago = {arqueiro.getNomeGolpePrimario(), arqueiro.getNomeGolpeSecundario(), arqueiro.getNomeDoEspecial()};
            	...
            	if(habilidade == 0){
            		arqueiro.golpePrimario();
            	} else if (habilidade == 1){
            		arqueiro.golpeSecundario();
            	} else if (habilidade == 2){
            		arqueiro.golpeEspecial();
            	}
           	...
           	if(a == 1){
           		...
           		JOptionPane.showMessageDialog(null, "Vencedor: " + bomba.getNome() + "\n" + "Vida: " + bomba.getVida());
           		JOptionPane.showMessageDialog(null, "Ce é  bixão mesmo eim doido");
           	}
        }
